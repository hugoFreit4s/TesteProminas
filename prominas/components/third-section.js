...
const ThirdSection = () => {
    return (
        <section className="z-1 w-full container h-full ml-auto mr-auto" style={{ height: "703px", width: "100%", display: "grid", gridTemplateRows: "150px 160px 500px" }} >
